...
// Deploy to: Supabase Dashboard → Edge Functions → laluna-reservation
...
serve(async (req) => {
  try {
    ...
    const cancelUrl = `https://coyolnosara.com/laluna/cancel?token=${record.cancel_token}`
...
<tr><td align="center" style="padding:40px 40px 20px 40px;">
  ...
  <h1 style="color:#1A1F16;font-size:28px;margin:0;font-weight:normal;font-style:italic;">La Luna</h1>
...
<tr><td style="padding:20px 40px;">
  ...
  <p style="color:#444;font-size:15px;line-height:1.6;margin:0;">Your reservation at La Luna has been confirmed. We look forward to welcoming you!</p>
</td></tr>
...
<tr><td align="center" style="padding:0 40px 30px 40px;">
  <a href="https://www.google.com/maps/search/La+Luna+Restaurant+Nosara+Costa+Rica" 
...
<tr><td style="padding:20px 40px;border-top:1px solid #eee;">
  ...
  <a href="${cancelUrl}" style="color:#A65D3F;font-size:13px;text-decoration:underline;">Click here to cancel your reservation</a>
</td></tr>

<!-- Footer -->
<tr><td align="center" style="padding:20px 40px 30px 40px;background:#f9f8f6;">
  <p style="color:#888;font-size:12px;margin:0;">La Luna Restaurant · Guiones, Nosara · +506 8996-8221</p>
</td></tr>
